...
import Common.BIBusHeaderHelper;
...
public class reportrunner
{
	...
	public static void main(String[] args)
	{
		...
		// different port.
		String serverHost = "9.110.83.168";
		String serverPort = "9080";
		
		// Parameter Names=Value
		String paramV = "overview=104";

		// Change this search path if you want to run a different report.
		String reportPath =	"/content/folder[@name='zy_test']/interactiveReport[@name='overview']";

		// Output filename
		String outputPath = "overview.html";
...
//		ParameterValue parameters[] = new ParameterValue[] {};
		...
		ParameterValue parameters[] = getParameter(paramV);
...
//			AsynchReply res_get = repService.getOutput(new SearchPathSingleObject(reportPath), parameters, runOptions);
			
//			String rid = res_get.getDetails()[6].toString();
			
			SearchPathSingleObject eg = new SearchPathSingleObject(reportPath);
